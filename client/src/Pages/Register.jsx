            ...
            <div style={styles.hero}>
                <div style={styles.heroContent}>
                    <h1 style={styles.heroTitle}>
                        <span style={styles.heroTitleGradient}>Join Our</span> Community
                    </h1>
            ...
            <div style={styles.formContainer}>
                <div style={styles.form}>
                    <div style={styles.formHeader}>
                        ...
                        <p style={styles.formSubtitle}>Enter your details to get started</p>
                    </div>
                ...
                <div style={styles.welcomeCard}>
                    ...
                    <h3 style={styles.welcomeTitle}>Welcome to Our Platform</h3>
                    ...
                    <div style={styles.features}>
                        <div style={styles.feature}>
                            ...
                            <span style={styles.featureText}>Write Stories</span>
                        </div>
                        <div style={styles.feature}>
                            
                            <span style={styles.featureText}>Meet Writers</span>
                        </div>
                        <div style={styles.feature}>
                            
                            <span style={styles.featureText}>Get Featured</span>
                        </div>
                    </div>
                </div>
            </div>
